    ...
    public partial class frmMain : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public void enableButtons()
        {
            ...
            if(Program.frmChinh.VAITRO.Text.Contains("NHANVIEN"))
            {
                ...
                rib_KhoiPhuc.Visible = false;
                rib_PhanQuyen.Visible = false;
            }
        ...
        public void btnLogout_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            LogoutAllForm();
        ...
        private void btnSaoLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
                    ...
                    MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                con.Open();*/
                string str = "USE QLKS;";
                string str1 = "BACKUP DATABASE QLKS TO DISK = 'D:\\backupQLKS.Bak' WITH FORMAT, NAME = 'Full Backup of QLKS';";
        ...
        private void btnKhoiPhuc_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if(!File.Exists(@"D:\\backupQLKS.Bak"))
            {
        ...
        {
            Form f = CheckExists(typeof(frmTaoTaiKhoan));
            if (f != null)
            {
                f.Activate();
            }
            ...
            {
                frmTaoTaiKhoan phong = new frmTaoTaiKhoan();
                //phong.MdiParent = this;
                phong.Show();
            }
        }
        ...
        {
            Form f = CheckExists(typeof(frmDoiMatKhau));
            if (f != null)
            {
                f.Activate();
            }
            ...
            {
                frmDoiMatKhau phong = new frmDoiMatKhau();
                //phong.MdiParent = this;
                phong.Show();
            }
        }

        private void btnXoaLoginKhoiVaiTro_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            Form f = CheckExists(typeof(frmXoaLogin));
            if (f != null)
            {
                f.Activate();
            }
            ...
            {
                frmXoaLogin phong = new frmXoaLogin();
                //phong.MdiParent = this;
                phong.Show();
            }
        }
